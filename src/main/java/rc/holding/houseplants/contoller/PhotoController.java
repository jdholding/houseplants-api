...
public class PhotoController {
  //    public PhotoController(PhotoRepository repo, PhotoService service, PhotoModelEmbeddedHandler
  // photoModelHandler){
  //        this.repo = repo;
  ...
  public CollectionModel<PhotoModel> getPhotos(
    ...
    var params =
        PhotoParams.builder()
            ...
            .sorters(
                Sorter.ofAliases(
                    sorters, PhotoParams.Field.SORTFIELD_MAP, PhotoParams.Field.DEFAULT_SORTER))
            .build();
  ...
  public EntityModel<PhotoModel> getPhotoById(
  ...
  public EntityModel<PhotoModel> insertPhoto(
      @RequestParam("photo") MultipartFile photoFile, @RequestParam("plantId") Integer plantId)
      throws IOException {
